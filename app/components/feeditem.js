          ...
          <div className="row">
            <div className="col-md-12">
              <ul className="list-inline">
                <li>
                <a href="#" onClick={(e) => this.handleLikeClick(e)}><span className="glyphicon glyphicon-thumbs-up"></span> {likeButtonText}</a>
                </li>
                <li>
        ...
        <div className="panel-footer">
          ...
          <CommentThread onPost={(commentText) => this.handleCommentPost(commentText)}>
            ...
            data.comments.map((comment, i) => {
              ...
              return (
                <Comment key={i} reactKey= {i} author={comment.author} postDate={comment.postDate} likeCounter={comment.likeCounter} dataId={this.state._id}> {comment.contents}</Comment>
              );
            })
            }
          </CommentThread>
